...
function triggerEffects(dep, dirtyLevel, debuggerEventExtraInfo) {
  ...
  for (const effect22 of dep.keys()) {
    let tracking;
    if (!dep.computed && effect22.computed) {
      if (effect22._runnings > 0 && (tracking != null ? tracking : tracking = dep.get(effect22) === effect22._trackId)) {
        effect22._dirtyLevel = 2;
        continue;
      }
    }
    if (effect22._dirtyLevel < dirtyLevel && (tracking != null ? tracking : tracking = dep.get(effect22) === effect22._trackId)) {
      ...
      if (effect22.computed && effect22._dirtyLevel === 2) {
        effect22._shouldSchedule = true;
      }
    ...
    if (effect22._shouldSchedule && (tracking != null ? tracking : tracking = dep.get(effect22) === effect22._trackId)) {
      ...
      effect22.trigger();
      if ((!effect22._runnings || effect22.allowRecurse) && effect22._dirtyLevel !== 3) {
